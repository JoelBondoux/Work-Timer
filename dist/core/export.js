...
export async function exportCsv(client, filters = {}) {
...
export async function exportPresetCsv(client, filters, presetId, options = {}) {
...
export async function exportXlsx(client, filters = {}) {
    const summary = await getBillingSummary(client, filters);
    const headerStyle = {
        fontWeight: 'bold',
        textColor: '#FFFFFF',
